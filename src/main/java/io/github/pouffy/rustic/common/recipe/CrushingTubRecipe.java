package io.github.pouffy.rustic.common.recipe;

import com.mojang.serialization.MapCodec;
import com.mojang.serialization.codecs.RecordCodecBuilder;
import io.github.pouffy.rustic.core.recipe.InWorldFluidRecipe;
...
public class CrushingTubRecipe extends InWorldFluidRecipe<SingleRecipeInput> {
    ...
    public CrushingTubRecipe(FluidStack out, Ingredient in, ItemStack by) {
        super(RusticRecipeTypes.Serializers.CRUSHING_TUB.get(), RusticRecipeTypes.CRUSHING_TUB.get(), out);
        this.input = in;
        this.byproduct = by;
    }
