...
public class RusticRecipeCollector {
    private final CompletableFuture<HolderLookup.Provider> lookupProvider;
    private final ExistingFileHelper existingFileHelper;
    private final DataGenerator generator;
    private final PackOutput packOutput;

    public RusticRecipeCollector(CompletableFuture<HolderLookup.Provider> lookupProvider, ExistingFileHelper existingFileHelper, DataGenerator generator, PackOutput packOutput) {
