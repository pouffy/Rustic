...
import io.github.pouffy.rustic.core.fluid.transfer.AbstractFluidContainerTransferProvider;
...
public class RusticFluidTransferProvider extends AbstractFluidContainerTransferProvider {

    public RusticFluidTransferProvider(PackOutput packOutput, CompletableFuture<HolderLookup.Provider> registries) {
        super(packOutput, registries, Rustic.MODID);
    }
